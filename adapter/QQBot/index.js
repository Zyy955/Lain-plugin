...
function createAndStartBot(cfg) {
    const bot = new QQBot({
        appid: cfg.appid,
        token: cfg.token,
        secret: cfg.secret,
        ...
        maxRetry: cfg.maxRetry || 10,
        intents: cfg.intents || ["GROUP_AT_MESSAGE_CREATE", "C2C_MESSAGE_CREATE"],
    })
...
Object.entries(config).forEach(([appid, botConfig]) => {
    createAndStartBot(botConfig)
})
// createAndStartBot(customBotConfig)
